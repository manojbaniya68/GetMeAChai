    ...
    <nav className="bg-gray-700 text-white flex justify-between items-center h-12 p-2 px-6">
      ...
      <div className="button">
          ...
          <div ref={dropdownRef} className="me-2 inline-block">
            ...
            <div
              ...
              className={`z-10 bg-white divide-y ${
                showDropDown ? "" : "hidden"
              } divide-gray-100 absolute right-32 rounded-lg shadow-sm w-44 dark:bg-gray-700`}
            >
              <ul
        ...
        {session && (
          <button
            onClick={() => signOut({ callbackUrl: "/" })}
            className="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 mx-1  py-2.5 text-center"
          >
            Sign Out
          </button>
        )}
